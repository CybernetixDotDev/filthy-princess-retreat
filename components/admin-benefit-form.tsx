...
export function AdminBenefitForm({ action, benefit, members }: { action: (formData: FormData) => void | Promise<void>; benefit?: InnerSanctumBenefitRow; members: InnerSanctumAdminMember[] }) {
