...
export default async function InnerSanctumLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="sanctum-shell">
    <header className="sanctum-header"><nav aria-label="Inner Sanctum navigation">
      ...
      <div className="sanctum-header-actions"><Link href="/inner-sanctum">Inside</Link><Link href="/inner-sanctum/tasks">Tasks</Link><Link href="/inner-sanctum/collection">Collection</Link><Link href="/inner-sanctum/benefits">Benefits</Link><Link href="/inner-sanctum/you">You</Link><form action={signOut}><button type="submit">Sign out</button></form></div>
    </nav></header>
