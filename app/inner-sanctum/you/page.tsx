...
export default async function InnerSanctumYouPage() {
  ...
  return <div className="sanctum-you"><header className="sanctum-you-intro"><p className="sanctum-eyebrow">Your corner</p><h1>You&apos;re still here.</h1><p>Good.</p></header>
    ...
    <nav className="sanctum-you-access" aria-label="Member access"><p className="sanctum-eyebrow">Member access</p><div><Link href="/inner-sanctum/collection">View collection</Link><Link href="/inner-sanctum/benefits">View benefits</Link><Link href="/inner-sanctum/tasks">View tasks</Link><form action={signOut}><button type="submit">Sign out</button></form></div></nav>
  </div>;
}
