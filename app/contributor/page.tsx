...
export default async function ContributorPage() {
 ...
 return <>
  ...
  {!hasAccess && <section className="hub-card hub-sanctum-invitation" aria-labelledby="hub-sanctum-title">
   <div className="hub-sanctum-copy">
    <h2 id="hub-sanctum-title">WHERE THE PRINCESS GETS THE FILTHIEST.</h2>
    <p>You can play out here.</p>
    <p>But inside the Inner Sanctum,<br />you can get so much closer to her.</p>
    <p>Invitations to <strong>Filthy Events</strong>.<br />Naughty surprises.<br />Member-exclusive rewards.</p>
    <p>And whatever the Princess decides to do next.</p>
    <Link className="hub-button" href="/store">Come inside →</Link>
   </div>
  </section>}
